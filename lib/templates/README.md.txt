...
Add this line to your application's Gemfile:
    ...
    gem 'rubyvernac-__lang__', git: "https://github.com/betacraft/rubyvernac-__lang__"
...
Or install it yourself as:
    ...
    $ gem build rubyvernac-__lang__.gemspec
    $ sudo gem install rubyvernac-__lang__-0.0.1.gem

## Usage

Run any example code using - 

    $ ruby___lang__ <file-path-here>

## Contributing

1. Fork it ( https://github.com/[my-github-username]/rubyvernac-__lang__/fork )
